...
routes.get('/agendas/colaboradores/:idSolicitacao', colaboradoresController.agendaReadAltera)
routes.get('/agendas/colaboradores/lista', colaboradoresController.listaTodos)
...
routes.get('/execucoes', agendasController.execucaoRead)
